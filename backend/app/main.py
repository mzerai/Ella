...
from app.routers import health, ella, pe_labs, rl_labs, aile_labs, agentic_labs, finance_labs, healthcare_labs, manufacturing_labs, admin, certificates, progress, access_codes
