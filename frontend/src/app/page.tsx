...
const COURSES: Course[] = [
  ...
  },
  {
    ...
    description: "Explorez les algorithmes RL avec des labs interactifs : Policy Evaluation, Value Iteration, Q-Learning et plus.",
    category: "Foundation",
    duration: "4 labs · 12h",
    available: true,
    link: "#",
  ...
  },
  {
    ...
    description: "Imagerie médicale, NLP clinique, aide à la décision. L'IA au service de la santé.",
    category: "Industry",
    duration: "3 jours · 18h",
    available: false,
    link: "#",
